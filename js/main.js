...
async function getShader(gl, shaderType, url) {
...
async function initShaders() {
    var fragmentShader = await getShader(gl, gl.FRAGMENT_SHADER, "./js/fragment.glsl");
    var vertexShader = await getShader(gl, gl.VERTEX_SHADER, "./js/vertex.glsl");
